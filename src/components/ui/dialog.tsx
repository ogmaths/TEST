...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "modal-backdrop fixed inset-0 z-40 bg-black/95 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => {
  // Add modal-open class to body when dialog opens
  React.useEffect(() => {
